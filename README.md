<h1 align="center">Hi, I'm Lihai Ben Haim 👋</h1>

<p align="center">
  <b>Full Stack & AI Engineer</b> · building scalable systems end to end<br/>
  <i>Backend · Frontend · DevOps · CI/CD · Applied AI</i>
</p>
...
- 🧠 **AI Engineer at Terra Security**, previously Full Stack Engineer at **Ludeo**, and engineering roles at **Noname**, **BigID**, and **Just UX**.
- 🛠️ Comfortable across the whole stack: backend services, frontend apps, testing automation, CI/CD, and DevOps.
- ⚡ I like going deep, from high level product features down to runtime and low level internals.
- 🎓 Software Engineering, SCE - Shamoon College of Engineering.
- 💬 Ask me about **TypeScript**, **Node.js**, **reactive programming**, **MongoDB**, and building maintainable monorepos.
